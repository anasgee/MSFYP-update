...
function App() {
  ...
  useEffect(() => {
    ...
    if (auth && auth.uid && profile.userType === "Admin") {
      dashboard = <AdminDashboard userType={profile.userType} links={links} />;
    } else if (auth && auth.uid && profile.userType === "Teacher") {
      dashboard = <TeacherDashboard userType={profile.userType} links={links} />;
    } else if (auth && auth.uid && profile.userType === "Student") {
      dashboard = <StudentDashboard userType={profile.userType} links={links} />;
    }
